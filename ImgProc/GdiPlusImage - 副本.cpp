...
{
    int nWidth = m_rcDest.Width();
    int nHeight = m_rcDest.Height();

    m_rcDest.left += point.x;
    m_rcDest.top  += point.y;
    m_rcDest.right = m_rcDest.left + nWidth;
    m_rcDest.bottom = m_rcDest.top + nHeight; 
}
